      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12 lg:px-[120px]">
        <ScrollReveal>
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl text-deep-black tracking-wider">
              Testimonials
            </h2>
          </div>
        </ScrollReveal>
        ...
        <div className="relative mx-auto w-full max-w-[900px]">
          ...
          >
            ...
            {/* Custom Navigation - hide arrows on mobile, show on md+ */}
            <div className="flex items-center justify-center gap-4 mt-10 pb-2">
              <button
                onClick={() => api?.scrollPrev()}
                className="hidden md:flex w-10 h-10 rounded-full bg-deep-black text-white items-center justify-center hover:scale-105 active:scale-95 transition-all duration-300 shadow-md"
            ...
            {testimonials.map((_, i) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all ${
                  current - 1 === i ? "bg-deep-black w-6" : "bg-deep-black/30"
                }`}
